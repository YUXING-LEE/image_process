...
"""
ave=cv2.meanStdDev(gray)
print(ave)
ret2, thresh2 = cv2.threshold(gray,ave[0]-ave[1],255,1)
ret, thresh = cv2.threshold(gray,ave[0]+ave[1],255,0) #cv2.THRESH_TRIANGLE 
"""

ret2, thresh2 = cv2.threshold(gray,110,255,1)
ret, thresh = cv2.threshold(gray,150,255,0) #cv2.THRESH_TRIANGLE 
